...
class stellar:
    ...
    def star(self):
        ...
        sphere(pos=vector(0,0,0),texture="https://i.imgur.com/1nVWbbd.jpg",radius=self.rad)
        sphere(color=color.white,opacity=chem1.k,radius=self.rad,shininess=10000)
...
def temperature(k):
    ...
    c=3*math.pow(10,8)
    de=chem1.d
    diffeq=Eq(t.diff(r)+(3*chem1.k*de*de*chem1.q)/(4*a*c*t*t*t))
#     display(diffeq)
